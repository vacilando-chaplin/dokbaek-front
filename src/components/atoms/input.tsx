    ...
    <div className="flex h-10 w-full items-center gap-2 rounded-xl border border-border-default-light bg-background-surface-light px-3 py-[11px] text-body3 font-normal leading-body3 tracking-body3 text-content-primary-light placeholder-content-alternative-light">
      {icon === "instagram" && (
        ...
        >
          <path
            ...
            fill="#212529"
            className={`${value ? "fill-content-primary-light" : "fill-content-secondary-light"}`}
          />
        </svg>
      )}
      {icon === "youtube" && (
      ...
      {dropdown && (
        ...
        >
          ...
          >
            <path
              d="M12.7526 15.1399C12.3542 15.5952 11.6458 15.5952 11.2474 15.1399L6.4512 9.6585C5.88544 9.01192 6.34462 8 7.20377 8L16.7962 8C17.6554 8 18.1146 9.01192 17.5488 9.6585L12.7526 15.1399Z"
              fill="#212529"
            />
          </svg>
        </button>
