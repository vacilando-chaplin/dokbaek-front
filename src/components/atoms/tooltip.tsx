...
const Tooltip = ({ placement, text, font = "font-semibold" }: TooltipProps) => {
  return (
    <div className="interaction-default relative flex h-auto w-auto max-w-80 items-center justify-center gap-0.5 rounded-lg bg-accent-primary-light px-2.5 py-1.5 shadow-low dark:bg-accent-primary-dark">
      ...
      <label
        className={`typography-body2 whitespace-nowrap text-left ${font} text-content-on_color-light dark:text-content-on_color-dark`}
      >
        {text}
      </label>
      {placement === "bottom" && (
