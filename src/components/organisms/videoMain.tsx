...
const VideoMain = ({ videoList, onVideoModalActive }: VideoMainProps) => {
  return (
            ...
            {videoList.map((video: VideoTypes) => {
              return (
                <div key={video.id}>
                  ...
                  {/* edit */}
                  {/* <button
                    className="absolute right-7 top-1 h-auto w-auto rounded-md border border-border-default-light bg-background-surface-light p-1 outline-none"
                    type="button"
