  ...
  return (
    <section className="fixed inset-0 z-[999] flex h-auto max-h-full min-h-[80vh] w-full items-center justify-center overflow-y-auto overflow-x-hidden bg-background-scrim-light bg-opacity-40 md:inset-0">
      <div className="relative max-h-full w-full max-w-[480px]">
        <div className="interaction-default relative flex h-auto w-full animate-enter flex-col items-center justify-center gap-10 rounded-3xl bg-background-elevated-light p-8 shadow-medium">
          <label className="typography-heading3 flex h-auto w-full gap-2 font-semibold text-content-primary-light">
            작품 활동을 삭제할까요?
          </label>
