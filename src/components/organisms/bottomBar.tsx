...
const BottomBar = () => {
  return (
    <section className="fixed bottom-0 flex h-auto w-full items-center justify-between border-t-[1px] bg-background-elevated-light px-6 py-3 shadow-footer">
