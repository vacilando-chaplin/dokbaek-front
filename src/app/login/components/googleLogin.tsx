...
const GoogleLogin = () => {
  ...
  return (
    <button
      type="button"
      className="interaction-default relative flex h-auto w-full flex-row items-center justify-center gap-2 rounded-[14px] border border-border-default-light px-6 py-3 hover:brightness-90 active:brightness-[80%]"
