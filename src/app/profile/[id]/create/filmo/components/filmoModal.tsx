...
import FilmoModalContents from "@/app/profile/[id]/create/filmo/components/filmoModalContents";
...
import { filmoCategory, filmoRole, toastMessage } from "@/lib/atoms";
import {
...
const FilmoModal = () => {
  ...
  const filmoRoleList = useRecoilValue<FilmoRoleType[]>(filmoRole);
  const filmoCategoryList = useRecoilValue<FilmoCategoryType[]>(filmoCategory);
